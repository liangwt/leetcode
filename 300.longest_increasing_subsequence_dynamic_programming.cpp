...
/**
 * 对于 1, 5, 3, 4, 6, 9, 7, 8
 * 当以8结束的最长子序列前一个元素必然是在8之前且比8小的元素
 * 即有可能时1，5，3，4，6，7
 * 
 ...
 * 可以看出对于以8结束的最长子序列被分割成了更细小的子问题，且子问题是相同的
 * 所以我们说此问题具有最优子结构，且具有重叠子问题
 * 
 ...
 *  ...
 * 
 * 注意最后得到的结果并不是dp[7]，而是dp数组中的最大值，因为dp[7]代表的是包含最后一个元素的最长子序列
 * 而整个数组的最长子序列有可能不包含最后一个元素
 */
